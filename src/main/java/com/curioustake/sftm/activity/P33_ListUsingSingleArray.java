...
import com.curioustake.sftm.datastructure.RListUsingSingleArray;
...
public class P33_ListUsingSingleArray implements Activity {
    ...
    public void invoke(String[] args) {
        ...
        RListUsingSingleArray treatment = new RListUsingSingleArray();
    ...
    private void throwException(final String operation, List<Integer> control, RListUsingSingleArray treatment) {
