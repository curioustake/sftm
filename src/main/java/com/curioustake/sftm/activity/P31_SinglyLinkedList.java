...
import com.curioustake.sftm.datastructure.RSinglyLinkedList;
...
public class P31_SinglyLinkedList implements Activity {
    ...
    public void invoke(String[] args) {
        ...
        RSinglyLinkedList treatment = new RSinglyLinkedList();
    ...
    private void throwException(final String operation, List<Integer> control, RSinglyLinkedList treatment) {
