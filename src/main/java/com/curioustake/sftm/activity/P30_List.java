...
import com.curioustake.sftm.datastructure.RList;
...
public class P30_List implements Activity {
    ...
    private void throwException(final String operation, List<Integer> control, RList treatment) {
