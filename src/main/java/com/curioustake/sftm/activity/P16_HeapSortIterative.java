...
public class P16_HeapSortIterative implements Activity {
    ...
    public void invoke(String[] args) {
        ...
        // HEAP SORT ITERATIVE ASCENDING
        Integer[] inputAsc = original.clone();
        sort(inputAsc, SORT_ORDER.ASCENDING);
        System.out.println("\n###################### HEAP SORT ITERATIVE validateSortAscending ##############################");
        System.out.println("\nHEAP SORT ITERATIVE ASCENDING SUCCESSFUL? [" + DataValidator.validateSortAscending(original, inputAsc, printResults) + "]\n");
        System.out.println("############################################################################################\n");

        // HEAP SORT ITERATIVE DESCENDING
        Integer[] inputDesc = original.clone();
        sort(inputDesc, SORT_ORDER.DESCENDING);
        System.out.println("\n###################### HEAP SORT ITERATIVE validateSortDescending #############################");
        System.out.println("\nHEAP SORT ITERATIVE DESCENDING SUCCESSFUL? [" + DataValidator.validateSortDescending(original, inputDesc, printResults) + "]\n");
        System.out.println("############################################################################################\n");
    ...
    private void heapifyNode(final Integer[] input, int node, final int lastParentNode, final int heapSize, final SORT_ORDER sortOrder) {
