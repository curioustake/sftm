...
import com.curioustake.sftm.datastructure.RStack;
...
/**
 * Purpose : Testing Stack implementation using arrays
 *
 * Complexity (Time):
 * */

public class P26_StackUsingArrays extends Stack<Integer> implements Activity {

    enum OPERATIONS {PUSH, POP, PEEK, EMPTY, SEARCH}
    ...
    public void invoke(String[] args) {
        ...
        for(int i=0; i<original.length;) {
            OPERATIONS operation = treatment.empty() ?
                    OPERATIONS.PUSH : OPERATIONS.values()[random.nextInt(OPERATIONS.SEARCH.ordinal()  + 1)];
    ...
    private void throwException(final String operation, Stack control, RStack treatment) {
