...
import com.curioustake.sftm.datastructure.RQueueUsingStack;
...
public class P29_QueueUsingStack implements Activity {
    ...
    public void invoke(String[] args) {
        ...
        RQueueUsingStack treatment = new RQueueUsingStack();
    ...
    private void throwException(final String operation, Queue control, RQueueUsingStack treatment) {
